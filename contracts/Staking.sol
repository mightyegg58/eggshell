...
contract Staking is ReentrancyGuard{
  ...
  // This is for Staking token using the ERC20 Interface which will be used
  // By inherted ReentrancyGuard
  ...
  // These events will have the address of the user and amount staked, withdrawn
  // and rewards claimed by him/her
